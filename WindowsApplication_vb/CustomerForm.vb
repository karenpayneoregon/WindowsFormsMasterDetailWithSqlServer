...
Public Class CustomerForm
    ...
    Public Sub New(AddMode As Boolean, stateInfo As List(Of StateItems), ByRef currentRow As DataRow)
        InitializeComponent()
        inAddMode = AddMode
        stateItems = stateInfo
        CustomerRow = currentRow
    End Sub
    Public Sub New(AddMode As Boolean, stateInfo As List(Of StateItems))
        InitializeComponent()
        inAddMode = AddMode
        stateItems = stateInfo
    End Sub
    ...
    Private Sub cmdAccept_Click(sender As Object, e As EventArgs) Handles cmdAccept.Click
        ...
        Else
            If Not inAddMode Then
                ...
                CustomerRow.SetField("FirstName", txtFirstName.Text)
                CustomerRow.SetField("LastName", txtLastName.Text)
                CustomerRow.SetField("Address", txtAddress.Text)
                CustomerRow.SetField("City", txtCity.Text)
                CustomerRow.SetField("State", cboStates.Text)
                CustomerRow.SetField("ZipCode", txtZipCode.Text)
